...
List your expenses and filter by year <br>
(the charts show proportionally the expenses of each month)<br><br>
...
Add a new expense to the list <br><br>
...
Edit or delete existing expense <br><br>
